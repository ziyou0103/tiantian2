...
def index(request):
    ...
    context = {
        'title': '首页', 'page_num': 2, 'cart_count': cart_count,
...
def list(request, typeid, sortid, pageid):
    ...
    context = {
        ...
        'paginator': paginator, 'sortid': sortid, 'cart_count': cart_count,
...
def detail(request, id):
    ...
    context = {
        ...
        'type0': type0, 'type1': type1, 'type2': type2, 'cart_count': cart_count,
